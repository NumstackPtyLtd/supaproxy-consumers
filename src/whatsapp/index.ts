    ...
    fields: [
      {
        ...
        required: true,
        placeholder: '123456789012345',
        helpText: 'The WhatsApp phone number ID from Meta Business settings.',
        pattern: '^[0-9]{10,20}$',
        patternError: 'Must be a numeric ID between 10 and 20 digits.',
      },
      {
        name: 'channelName',
        label: 'Display name',
        ...
        patternError: 'Enter a valid phone number format.',
      },
    ],
  },
